...
const columns: MParamLabel[] = [
  { param: 'id', label: 'id' },
  { param: 'name', label: '名称' },
  { param: 'password', label: '密码', props: { type: 'password' } },
  { param: 'checkbox', label: '选择', type: 'checkbox' }
];

const modelValue = ref({ id: 1, name: '阿怪', age: 18,checkbox:false, address: '浙江省杭州市', password: '' });
</script>
